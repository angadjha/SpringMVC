...
<head>
    ...
    <title>About Us | Starting Theme</title>
...
<body>
    ...
    <section id="about-us" class="container">
        ...
        <div id="meet-the-team" class="row">
            <div class="col-md-3 col-xs-6">
                <div class="center">
                    <p><img class="img-responsive img-thumbnail img-circle" src="${pageContext.request.contextPath}/assets/img/team-member.jpg" alt="" ></p>
    ...
    <script src="${pageContext.request.contextPath}/assets/jsjs/bootstrap.min.js"></script>
    <script src="${pageContext.request.contextPath}/assets/jsjs/jquery.prettyPhoto.js"></script>
    <script src="${pageContext.request.contextPath}/assets/jsjs/main.js"></script>
</body>
</html>