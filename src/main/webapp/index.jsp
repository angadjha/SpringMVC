    ...
    <header class="navbar navbar-inverse navbar-fixed-top wet-asphalt" role="banner">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><img src="${pageContext.request.contextPath}/assets/img/logo.png" alt="logo"></a>
            </div>
    ...
    <section id="main-slider" class="no-margin">
        <div class="carousel slide wet-asphalt">
            ...
            <div class="carousel-inner">
                <div class="item active" style="background-image: url(${pageContext.request.contextPath}/assets/img/slider/bg1.jpg)">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                ...
                <div class="item" style="background-image: url(${pageContext.request.contextPath}/assets/img/slider/bg2.jpg)">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                ...
                <div class="item" style="background-image: url(${pageContext.request.contextPath}/assets/img/slider/bg3.jpg)">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="carousel-content centered">
                            ...
                            <div class="item active">
                                <div class="row">
                                    <div class="col-xs-4">
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                <img class="img-responsive" src="${pageContext.request.contextPath}/assets/img/portfolio/recent/item1.png" alt="">
                                                <h5>
                                                    Nova - Corporate site template
                                                </h5>
                                                <div class="overlay">
                                                    <a class="preview btn btn-danger" title="Malesuada fames ac turpis egestas" href="${pageContext.request.contextPath}/assets/img/portfolio/full/item1.jpg" rel="prettyPhoto"><i class="icon-eye-open"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>                            
                                    <div class="col-xs-4">
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                <img class="img-responsive" src="${pageContext.request.contextPath}/assets/img/portfolio/recent/item3.png" alt="">
                                                <h5>
                                    ...
                                    <div class="col-xs-4">
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                <img class="img-responsive" src="${pageContext.request.contextPath}/assets/img/portfolio/recent/item2.png" alt="">
                                                <h5>
